...
def execute(bot):
    ...
    while time.time() - start_time < max_wait:
        ...
        is_loading_3, _ = bot.click_image_template("QQ农场-精彩体验马上开始-2.png", action="check", suppress_warning=True, return_details=True, prefix="【登陆农场】", ignore_color=True)
        
        if not is_loading_1 and not is_loading_2 and not is_loading_3:
